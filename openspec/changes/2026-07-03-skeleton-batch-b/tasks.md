# Tasks — skeleton-batch-b

- [x] 1.1 expressive.json + creative-multiscale.json + retro.json: root skeleton field (collage / mosaic / poster)
- [x] 1.2 `src/demo-collage.ts` per proposal table (+ko block)
- [x] 1.3 `src/demo-mosaic.ts` + `src/demo-poster.ts` per proposal tables (+ko blocks)
