...
function mosaicDemoCss(doc: TokensDocument, tier: DemoTier, ko: boolean): string {
  ...
  return `${toCssVars(doc)}
    * { box-sizing: border-box; }
    ...
    .eyebrow { font-family: var(--primitive-font-family-mono, ui-monospace, monospace); text-transform: uppercase; letter-spacing: .08em; font-size: .78rem; color: ${textMix(62, "mosaic.eyebrow")}; }
    .lead { max-width: 52ch; color: ${textMix(76, "mosaic.lead")}; font: var(--semantic-typography-body-weight) var(--semantic-typography-body-size)/var(--semantic-typography-body-lineHeight) var(--semantic-typography-body-family); letter-spacing: calc(var(--semantic-typography-body-tracking) * 1em); }
    ...
    .mosaic-card p { color: ${textMix(72, "mosaic.card")}; }
